...
function ajax_showTooltip(e,externalFile,inputObj)
{
   ...
   if(document.all)e = event;
	...
	if(!ajax_tooltipObj)	/* Tooltip div not created yet ? */
	{
		...
		buttonDiv.style.cssText = 'position:absolute;padding-left:215px;bottom:0px;text-align:right;background-color:#FFF;font-size:0.8em;height:15px;';
		buttonDiv.innerHTML = '<a href="#" onclick="ajax_hideTooltip();return false"><img src="/images/close.jpg" border=0/></a>';
