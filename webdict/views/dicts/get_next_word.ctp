...
if (!empty($result)) {
	...
	if (empty($checkWord)) 
			echo "<div style='padding-bottom: 10px;padding-left: 0px; display: inline;padding-top: 10px;font-size: 14px;float: left;' id='addword'><a href='javascript:addword(".$tmp['id'].");'><img src='/images/add.jpg' border=0 width='20' height='20' style='vertical-align: middle;'/>Thêm vào từ vựng của tôi</a></div><br/><br/>";
...
if (isPlaying) 
	alertTimerId = setTimeout("getWord(" + <?php echo $result[0]['words']['id']; ?> + ", " + <?php echo $isPlaying; ?> + ")", <?php echo $timedOut; ?>);
//getWord(<?php echo $result[0]['words']['id']; ?>);
